...
public class TesteBancoJdbc {
	...
	public void initAtualizar() {
		try {
			...
			objetoBanco.setNome("Laura Rangel");
	...
	/*Metodo para testar a classe de inserção de telefone no BD*/
	@Test
	public void testeInserteTelefone() {

		Telefone telefone = new Telefone();
		telefone.setNumero("(31) 3595-7699");
		telefone.setTipo("casa");
		telefone.setUsuariopessoa(11L); //deve converter para Long usando o 'L'
	...
	//Testando a exclusão de tabelas pais e filhos
	@Test
